...
<html prefix="og: http://ogp.me/ns# 
	...
	<head>
		...
		<title><?php echo isset($data->title)?$data->title: null;?></title>
		<meta property="og:type"  content="og:article" />
		<meta property="og:image" content="<?php echo BASE_URL?><?php echo isset($data->img)?$data->img: null;?>"/> 
		<meta property="og:title" content="<?php echo isset($data->title)?$data->title: null;?>"/> 
		...
		<meta property="og:description" content="<?php echo isset($data->brief)?$data->brief: null;?>" />
		<meta name="keywords" content="<?php echo isset($data->keywords)?$data->keywords: null;?>" />
		<meta name="description" content="<?php echo isset($data->description)?$data->description: null;?>" />
