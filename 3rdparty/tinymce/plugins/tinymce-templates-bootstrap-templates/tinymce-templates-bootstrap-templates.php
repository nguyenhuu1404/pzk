...
class Tinymce_Templates_Bootstrap_Templates
{
	...
	public function get_templates()
	{
		return array(
			...
			'template-creative' => array(
				'title'			=> 'Creative Template',
				'url'			=> '/default/template/creative.html'
			),
			'timeline' => array(
				'title'			=> 'Timeline',
				'url'			=> '/default/template/timeline.html'
			),
			'login' => array(
				'title'			=> 'Login',
				'url'			=> '/default/template/login.html'
			),
			'forum'	=> array(
				'title'			=> 'Forum',
				'url'			=> '/default/template/forum.html'
			),
			'resume'	=> array(
				'title'			=> 'Resume',
				'url'			=> '/default/template/resume.html'
			),
			'creditcard'	=> array(
				'title'			=> 'Credit Card',
				'url'			=> '/default/template/creditcard.html'
			),
			'skills'	=> array(
				'title'			=> 'Stylish Skills',
				'url'			=> '/default/template/skills.html'
			),
			'pricing'	=> array(
				'title'			=> 'Pricing Table',
				'url'			=> '/default/template/pricing.html'
			),
			'signin'	=> array(
				'title'			=> 'Sign In',
				'url'			=> '/default/template/signin.html'
			),
			'feed'	=> array(
				'title'			=> 'Feed',
				'url'			=> '/default/template/feed.html'
			),
			'navbarlogoresponsive'	=> array(
				'title'			=> 'Navbar Logo Responsive',
				'url'			=> '/default/template/navbarlogoresponsive.html'
			),
			'portfolio'	=> array(
				'title'			=> 'Portfolio',
				'url'			=> '/default/template/portfolio.html'
			),
		);
	}
}
$tinymce_templates_bootstrap_templates = new Tinymce_Templates_Bootstrap_Templates();
$templates = $tinymce_templates_bootstrap_templates->get_templates();
